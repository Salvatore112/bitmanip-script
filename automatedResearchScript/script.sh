...
Help()
{
   ...
   echo -e "<optimization_flag> - level of optimization (one should use a flag, i'e \"-O3\" or \"-O0\")"
   echo -e "<microarchitecture_flag> - target's microarchitecture_flag (one should use a flag, i.e \"-march=riscv64\")"
   echo
}
